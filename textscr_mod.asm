...
ScrollFont		LOGFONT <18,9,0,0,FW_NORMAL,0,0,0,DEFAULT_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,\
									DEFAULT_QUALITY	,0,'Verdana'>
ScrollText	    		db	"PERYFERiAH tEAM present an MD5 keygen for Vocal Remover Pro 2.0                                               "
