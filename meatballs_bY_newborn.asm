...
AboutText 		db "PERYFERiAH tEAM Proudly Present",0
				db "Vocal Remover Pro 2.0",13
				db "KeyGen by GRUiA [PRF]",0
				db "Protection : MD5",13
				db "Date : 15.12.2021",13
				db "Music : <picnic in the meadows>",0
				db "Shoutoutz 2:",0
				db "KayBee 4 music",13,"newborn for meatballz effect",13,"r0ger for GFX",13,"MagicH for v2m replayer",0
                db "greetz 2 all my friends",13
                db "and memberz incl...",0
                db "Al0hA,B@TRyNU,r0bica",13
                db "ShTEFY,DAViiiiDDDDDDD,r0ger",13
...
AboutFont       LOGFONT  <12h,0,0,0,320h,0,0,0,DEFAULT_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY, 0,"Verdana">
...
;LOCAL hdc:DWORD
                ...
                invoke SetTextAlign,m_hDC,TA_RIGHT
                xor eax,eax
                ret
AboutInit endp
